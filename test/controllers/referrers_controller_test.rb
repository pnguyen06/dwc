...
class ReferrersControllerTest < ActionController::TestCase
  ...
  test "should create referrer" do
    assert_difference('Referrer.count') do
      post :create, referrer: { breakroom: @referrer.breakroom, email: @referrer.email, referrals: @referrer.referrals }
    end
  ...
  test "should update referrer" do
    patch :update, id: @referrer, referrer: { breakroom: @referrer.breakroom, email: @referrer.email, referrals: @referrer.referrals }
    assert_redirected_to referrer_path(assigns(:referrer))
  end
